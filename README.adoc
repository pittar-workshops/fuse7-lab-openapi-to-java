...
[Open in CodeReady Workspaces](https://codeready-openshift-workspaces.apps.cluster-943d.943d.example.opentlc.com/f?url=https://github.com/pittar-workshops/fuse7-lab-openapi-to-java/tree/main)
